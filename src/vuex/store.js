...
const mutations = {
  ...
  trackBlockSelect (state, params) {
    ...
    realTarget.style.boxShadow = 'inset 0px 0px 1px 3px #409eff'
    // 暂时兼容未使用vuex的视频素材轨道
  ...
  dragStart (state, params) {
    ...
    if (state.prefix === 'text') {
      ...
      state.mouseElement.style.boxShadow = '#ccc 0px 0px 1px 1px inset'
  ...
  dragTrackEnter (state, e) {
    ...
    target.style.boxShadow = 'inset 0px 0px 1px 3px #409eff'
  },
